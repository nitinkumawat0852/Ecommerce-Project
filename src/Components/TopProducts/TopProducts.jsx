...
function TopProducts({handleOderPopup}) {
    return (
          ...
          <p data-aos="fade-up" className="text-sm text-gray-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 md:gap-5 place-items-center">
                {ProductsData.map((data)=>(
                     <div data-aos="zoom-in" className="rounded-2xl text-center py-2 bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-[#4263eb] hover:text-white relative shadow-xl duration-300 group max-w-[300px]">
